...
import http.client as httplib #for the HTTP request
        ...
        if configHandler.checkConfig("BosMon1"): #read and debug the config
            ...
            try:
                ...
                if globalVars.config.get("BosMon1", "bosmon1_user"):
                    ...
                    globalVars.config.get("BosMon1", "bosmon1_password")
                    )
                headers['Authorization'] = "Basic {0}".format(base64.b64encode(auth_string.encode("utf-8")).decode("ascii"))
                ...
                if typ == "FMS":
                    ...
                    try:
                        ...
                        logging.info("send FMS to BosMon1")
                    except:
                    ...
                    try:
                        ...
                        # dispatch the BosMon-request
                        bosMonRequest(httprequest, params, headers)
                        logging.info("send POCSAG to BosMon1")
                    except:
