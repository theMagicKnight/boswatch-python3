...
apt-get -y install git cmake build-essential libusb-1.0-0-dev qmake6 qt6-base-dev libpulse-dev libx11-dev sox >> ${boswatch_install_path}/setup_log.txt 2>&1
